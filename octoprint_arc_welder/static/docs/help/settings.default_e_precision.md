This is the number of decimal places that will be outputted for the E parameters.  If *Allow Dynamic Precision* is enabled, the precision may increase.  Default = 5
